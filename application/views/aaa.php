...
if ($sess_level == "guru") {
  $menu = array(
            ...
            array("icon"=>"user", "url"=>"tanya_jawab", "text"=>"Tanya Jawab"),
            array("icon"=>"user", "url"=>"tanya_jawab_guest", "text"=>"Guest"),
          );
} else if ($sess_level == "siswa") {
  $menu = array(
            array("icon"=>"dashboard", "url"=>"", "text"=>"Dashboard"),
            array("icon"=>"file", "url"=>"ikuti_ujian", "text"=>"Ujian"),
            array("icon"=>"book", "url"=>"angket_penilaian", "text"=>"Angket Penilaian"),
            array("icon"=>"user", "url"=>"tanya_jawab", "text"=>"Tanya Jawab"),
          );
  ...
  $menu = array(
            ...
            array("icon"=>"list-alt", "url"=>"m_soal", "text"=>"Soal"),
            array("icon"=>"list-alt", "url"=>"m_soal_angket", "text"=>"Angket"),
            array("icon"=>"file", "url"=>"h_angket", "text"=>"Hasil Angket"),
            array("icon"=>"file", "url"=>"h_ujian", "text"=>"Hasil Ujian"),
          );
} else {
  $menu = array(
...
<div class="col-md-12" style="border-top: solid 4px #ddd; text-align: center; padding-top: 10px; margin-top: 50px; margin-bottom: 20px">
  &copy; 2018 <a href="<?php echo base_url(); ?>adm">Aplikasi Ujian Pernikahan Online</a>. 
</div>
...
var r = confirm('Username otomatis adalah "siswa'+id+'", dan Password otomatis adalah "admin", Lanjutkan?');
    if (r == true) {
        window.location(base_url+"adm/m_siswa/user/"+id);
    } else {
        console.log('gagal');
    }
</script>
